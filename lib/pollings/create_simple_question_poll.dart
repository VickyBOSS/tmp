...
class CreateSimpleQuestionPoll extends StatefulWidget {
  @override
  _CreateSimpleQuestionPollState createState() =>
      _CreateSimpleQuestionPollState();
}

class _CreateSimpleQuestionPollState extends State<CreateSimpleQuestionPoll> {
  ...
  void publishQuestion() {
    if (formKey.currentState.validate()) {
      ...
      Map<String, dynamic> questionData = {
        ...
        "a": controllers[selectedOption].text.trim(),
        "o": options
      };
      print(questionData);
